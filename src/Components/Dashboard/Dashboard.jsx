        ...
        <>
            <div className='flex flex-col'>
                ...
                <div className='flex flex-wrap'>
                    ...
                    {data && data.length &&
                        data?.map((data, index) =>
                            <div className='flex flex-col w-[300px] ml-8 mt-2' key={data.snippet.channelId+index}>
                                ...
                                <div className='bg-[#1e1e1e] text-[#ffffff] min-h-[180px] h-fit p-6 font-[600]'>
                                    <span><div className='hover:cursor-pointer' onClick={()=>{navigate("/videoes/"+data.snippet.channelId+"+"+data.id.videoId)}}>{data.snippet.title}</div> </span>
