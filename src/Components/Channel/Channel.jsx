                ...
                {data && data.length &&
                    data?.map((data,index) =>
                        <div className='flex flex-col cursor-pointer w-[300px] ml-8 mt-2' key={data.snippet.channelId+index}>
                            <div className='h-[180px] text-white' style={{ backgroundSize:'cover',backgroundPosition:'center center' ,backgroundRepeat:'no-repeat',backgroundImage: `url(${data.snippet.thumbnails.high.url})` }}></div>
