    ...
    return (
        <div className='bg-[#000000] flex justify-between mt-2'>
            ...
            <div className='flex justify-between mt-2 ml-8 rounded-full pr-2 pt-2 pb-4 w-[200px] md:w-[420px] mr-16 bg-[#ffffff] h-[40px] w-[300px]'>
                <span><input onChange={(e)=>{setSearch(e.target.value)}} className='w-[150px] md:w-[350px] outline-none ml-3 pb-1 h-[30px] placeholder:text-[15px]' placeholder="Search..." type="text" name="search" id="search" /></span>
